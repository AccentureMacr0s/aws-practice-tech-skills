...
Happy coding! 🚀  
Ты очень чётко сформулировал, что именно проверяют на **техническом интервью в Amazon для SysDE** (или DevOps/SRE-инженеров): это **не просто кодинг**, а **коммуникация, мышление и продакшн-инженерия** в реальном времени. Давай распишу, **как готовиться по каждому блоку**, чтобы соответствовать *"Amazon bar"*.
